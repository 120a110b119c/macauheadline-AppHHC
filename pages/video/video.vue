	...
	<view class="wrapBox">
		...
		<view class="titleBox">
			...
			<view class="contentText">
				<text style="color: #E5E5E5;font-size: 32upx;margin-right: 20upx;" :class="{itemActive:itemActive == '1'}" @tap="toSmallVideo('1')">{{i18n.videoLeft}}</text>
				<text style="color: #ccc;font-size: 32upx;" :class="{itemActive:itemActive == '2'}" @tap="toSmallVideo('2')">{{i18n.videoRight}}</text>
			</view>
