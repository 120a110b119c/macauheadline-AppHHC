<template>
	<view class="page">
		<header-title :title='"浏览历史"' @toBack='toMe()' :backText="'我的'" :iconfont='"&#xe728;"'></header-title>
		<load-refresh v-show="collectList.length != 0" ref="loadRefresh" :heightReduce="10" :backgroundCover="'#F3F5F5'" :pageNo="collectPage" :totalPageNo="totalPage"
		 :isRefresh="true" :refreshTime="800" @loadMore="loadMore()" @refresh="refresh" style="margin-bottom: '20upx';">
		...
		<u-empty img-width='170' margin-top='120' :show='collectList.length == 0' text="您暫時沒有瀏覽的歷史" mode="list"></u-empty>
	</view>
</template>
