...
<script>
	...
	import couponDetailPage from "../childComponent/content/couponDetailPage.vue"
	import CouponOne from "../childComponent/common/CouponOne.vue"
	...
	export default {
		...
		onLoad(option) {
			this.data = uni.getStorageSync('shoppingArray');
