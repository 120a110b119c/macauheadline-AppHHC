	...
	<view>
		<view class="list">
			<scroll-view scroll-y="true" :style="{height: swiperheight  + 'px'}">
					...
					<view v-for="(item,index) in DataList" class="DataList" :key="index">
						<view class="DataListWrap">
							<view class="DataListWrapLeft">
								<view class="checkButoon" v-show="breakRulesShopping">
				...
				<view class="buttonsList" v-show="breakRulesShopping">
...
<script>
	export default {
		...
		// onShow() {
		// 	console.log(this.tabCurrentIndex,'11111');
		// },
		...
		// 			this.breakRulesShopping = !this.breakRulesShopping
		// 		}
		// 	} else {
		// 		uni.navigateTo({
		// 			url: '../shoppingAdd/index'
		// 		});
		// 	}
		// },
		methods: {
